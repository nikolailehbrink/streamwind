<article id="post-<?php the_ID(); ?>" <?php post_class('mb-12'); ?>>
	...
	<?php else : ?>
		...
		<div class="entry-content">
			...
			the_content(
				sprintf(
					__('Continue reading %s', 'streamwind'),
			...
			wp_link_pages(
				array(
					'before'      => '<div class="page-links"><span class="page-links-title">' . __('Pages:', 'streamwind') . '</span>',
					'after'       => '</div>',
					'link_before' => '<span>',
					'link_after'  => '</span>',
					'pagelink'    => '<span class="screen-reader-text">' . __('Page', 'streamwind') . ' </span>%',
